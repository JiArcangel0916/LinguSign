...
const Translation = ({ onBack }) => {
  ...
  const renderMedia = (item) => {
    ...
    if (isVideo) {
      return (
        <video key={path} src={path} autoPlay muted loop style={{ width: "100%", height: "100%", objectFit: "contain" }} />
      );
    }
    return (
      <img src={path} alt="sign" style={{ width: "100%", height: "100%", objectFit: "contain" }} />
    );
  };
